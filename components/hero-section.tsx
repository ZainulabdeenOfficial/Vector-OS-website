...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[90vh] py-16 flex items-center overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="container mx-auto px-4 z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        <div className="flex-1 text-center lg:text-left">
          ...
          >
            We build innovative open source projects across multiple domains, from operating systems to developer tools,
        ...
        <motion.div
          ...
          className="flex-1 h-[300px] sm:h-[400px] md:h-[500px] w-full relative"
        >
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="relative">
              ...
              <div className="w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full bg-gradient-to-r from-primary to-purple-500 flex items-center justify-center relative z-10">
                <div className="w-[calc(100%-4px)] h-[calc(100%-4px)] rounded-full bg-background flex items-center justify-center">
                  <div className="w-[75%] h-[75%] rounded-full bg-gradient-to-r from-primary/20 to-purple-500/20 flex items-center justify-center">
                    <div className="w-[65%] h-[65%] rounded-full bg-gradient-to-r from-primary to-purple-500 flex items-center justify-center text-white font-bold text-sm sm:text-base md:text-lg lg:text-xl">
                      Vector OS
                    </div>
                  </div>
                </div>
            ...
            <div className="absolute inset-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-[250px] h-[250px] sm:w-[300px] sm:h-[300px] md:w-[350px] md:h-[350px] lg:w-[400px] lg:h-[400px] rounded-full border border-primary/20 animate-spin-slow"></div>
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-[300px] h-[300px] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px] rounded-full border border-purple-500/20 animate-spin-reverse-slow"></div>
              </div>
